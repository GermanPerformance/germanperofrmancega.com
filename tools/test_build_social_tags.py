...
<link rel="canonical" href="https://germanperformancega.com/german-car-oil-change-snellville-ga.html"/>
...
class ChooseImage(unittest.TestCase):
    def test_service_keyword_in_slug_picks_that_service_photo(self):
        self.assertEqual(social.choose_image("german-car-oil-change-snellville-ga.html"),
                         "assets/img/services/oil-change-1100.jpg")
        self.assertEqual(social.choose_image("german-car-ac-repair-snellville-ga.html"),
    ...
    def test_no_matching_photo_falls_back_to_the_site_image(self):
        self.assertEqual(social.choose_image("audi-repair-snellville-ga.html"), "og-image.jpg")
...
class Transform(unittest.TestCase):
    def test_block_is_inserted_after_the_canonical(self):
        out = social.transform(PAGE, "german-car-oil-change-snellville-ga.html")
        canonical = '<link rel="canonical" href="https://germanperformancega.com/german-car-oil-change-snellville-ga.html"/>\n'
        expected = canonical + "\n".join((
            ...
            '<meta property="og:url" content="https://germanperformancega.com/german-car-oil-change-snellville-ga.html">',
    ...
    def test_running_twice_changes_nothing(self):
        once = social.transform(PAGE, "german-car-oil-change-snellville-ga.html")
        self.assertEqual(social.transform(once, "german-car-oil-change-snellville-ga.html"), once)
    ...
    def test_existing_image_is_kept_when_the_block_is_refreshed(self):
        ...
        out = social.transform(retitled, "german-car-oil-change-snellville-ga.html")
    ...
    def test_legacy_self_closing_block_is_replaced_not_duplicated(self):
        ...
        out = social.transform(legacy, "german-car-oil-change-snellville-ga.html")
    ...
    def test_page_without_canonical_is_left_alone(self):
        page = PAGE.replace('<link rel="canonical" href="https://germanperformancega.com/german-car-oil-change-snellville-ga.html"/>\n', "")
