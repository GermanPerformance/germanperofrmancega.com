...
POSTS = [
    {
        ...
        "sections": [
            ...
            ("The coding after the part is part of the job", [
                ...
                f"{link('bmw-battery-replacement-snellville-ga.html', 'BMW battery replacement')} "
    ...
    },
    {
        ...
        "sections": [
            ...
            ("The part is not fixed until the car knows about it", [
                ...
                f"why a {link('bmw-battery-replacement-snellville-ga.html', 'BMW battery replacement')} "
